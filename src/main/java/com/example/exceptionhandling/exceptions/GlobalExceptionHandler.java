...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleIllegalStateException(IllegalStateException exception, WebRequest request) {
        log.error("Unknown error occurred", exception);
        return buildErrorResponse(exception, "Unknown 2 error occurred", HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<Object> handleObjectNotValidException(ObjectNotValidException exception, WebRequest request) {
        log.error("Unknown error occurred", exception);
